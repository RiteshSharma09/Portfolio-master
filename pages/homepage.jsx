...
export default function HomePage() {
	...
	return (
		<SectionHomePage id="section-home">
			...
			<Head
				title="Ritesh Sharma | Portfolio"
				metaDescription="Portfolio de Ritesh Sharma, projets et compétences"
				keywords="Ritesh Sharma, Cybersécurité, Programmation, CSIRT, Pentesting"
			/>
			<LandingPageContainer>

				<TitleLandingContainer>
					<SubTitleLanding>{language.landingPage.apresentationText}</SubTitleLanding>
					<Typed strings={["Ritesh Sharma"]} typeSpeed={80} className="type-string " />
