...
export default function SocialNetworkRowStack() {
	return (
		<SocialMediaContainer>
			...
			<ButtonSocialMediaIcon href="https://github.com/RiteshSharma09" target="_blank">
				<Github />
			</ButtonSocialMediaIcon>

			<ButtonSocialMediaIcon href="mailto:contact.riteshsharma94181@gmail.com" target="_blank">
				<MailSend />
			</ButtonSocialMediaIcon>

			<ButtonSocialMediaIcon href="https://www.linkedin.com/in/RiteshSharma9/	" target="_blank" data-splitbee-event="linkedin-access">
				<LinkedinSquare />
			</ButtonSocialMediaIcon>

			<ButtonSocialMediaIcon href="https://x.com/RiteshS75887309" target="_blank">
				<Twitter />
			</ButtonSocialMediaIcon>
